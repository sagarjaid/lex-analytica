...
const Phone = ({ className = "", ...props }) => {
  ...
  return (
    <div
      className={`relative bg-[url('/blue-2.png')] bg-white bg-cover bg-center bg-no-repeat ${className}`}
    ...
    >
      <div className="absolute inset-0 flex flex-col gap-4 items-center justify-center p-6">
        ...
        <div className="flex flex-row items-start justify-center space-x-0.5">
          {/* <p className="font-medium text-sm text-primary animate-wiggle">Reminder Call 📞 ...</p> */}
          <svg
            viewBox="0 0 68 77"
            xmlns="http://www.w3.org/2000/svg"
            className="w-10 h-12 fill-current -scale-x-100 pr-2 text-primary"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
            ...
            {!showOtpInput ? (
              <div
                className={`gradient-border ${
                  isInputActive ? "gradient-border-static" : ""
                }`}
              >
              ...
              <div
                className={`gradient-border ${
                  otp.length > 0 ? "gradient-border-static" : ""
                }`}
              >
                <div className="input-content">
                  <Input
          ...
          <div className="w-full max-w-sm ">
            {!showOtpInput ? (
              ...
              <div className="flex gap-2">
                ...
                <Button
                  className="flex-1 bg-black text-white hover:bg-gray-800 py-5"
        ...
        <div className="flex flex-col gap-2 mt-6">
          <a href="/">
            <img src={usedby.src} className="w-[180px] grayscale" />
          </a>
          <p className="text-center text-xs">289+ goals reminded today</p>
        </div>
      </div>
    </div>
  );
