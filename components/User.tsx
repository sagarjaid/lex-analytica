...
const UserInfo = () => {
  ...
  return (
    <>
      <div className="overflow-hidden  bg-base-100 p-1 w-full">
        <div className="space-y-2 text-sm">
          <div className="flex flex-col gap-2 p-2 w-full rounded-md font-medium">
            {user?.user_metadata?.avatar_url ? (
              ...
              <UserIcon
                strokeWidth={1.5}
                className="w-24 h-24 border border-gray-200 rounded-md p-4"
              />
            )}
